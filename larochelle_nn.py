def NN_SGD(X_train, y_train, X_validation, y_validation, h1, h2, epochs, Lambda, Reg, alpha, graph=False):
    '''
    x = np.array([[0],
                  [1], 
                  [2]])
    ...
    data_to_record = [source,binarize,gt,lt,vol,features,outputs,h1,h2,epochs,Lambda,Reg,alpha,experiment_time,last_mean_training_loss,last_mean_validation_loss,last_mean_training_loss_slope,last_mean_validation_loss_slope,best_last_epoch,best_last_mean_validation_loss]
